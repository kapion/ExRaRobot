 ...
 * 
 */
@WebServiceClient(name = "DailyInfo", targetNamespace = "http://web.cbr.ru/", wsdlLocation = "file:/C:/jProjects/exrobot/src/main/resources/static/DailyInfo.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
           // url = new URL("file:/C:/jProjects/exrobot/src/main/resources/static/DailyInfo.wsdl");
